/*
* ngapain ke sini:v
* Cie mau recode sc nya nisa:v
* tambahain lah nama athuor
* jangan ganti2 asal ntar eror marah🗿
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Nisa Cans\n'
            + 'ORG:Owner cans;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6252834278600:+62 852-8342-78600\n'
            + 'END:VCARD'
...
memberLimit = 2
ban = [""]
premium = ["62852834278600@s.whatsapp.net"]
		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `*Hallo Kak* ${pushname2} *Kayanya Kamu Blm Terdaftar Sebagai Teman Nisa*\n*Ketik ${prefix}daftar nama|umur*\n*Contoh ${prefix}daftar Nisa|17*`,
			...
			const ownerNumber = ["6285283427860062852834278600@s.whatsapp.net"] // owner number ubah aja
